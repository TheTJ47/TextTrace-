...
# Set the path to the tesseract executable relative to the current directory
pytesseract.pytesseract.tesseract_cmd = os.path.join('static', 'Tesseract-OCR', 'tesseract.exe')
